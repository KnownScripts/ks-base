...
local blips = {
    ...
    {id = "KASIINO1", name = "KASIINO", color = 5, sprite = 207, x = 925.329, y = 46.152, z = 80.908 },
    {id = "hosp1", name = "HAIGLA", scale = 0.75, color = 2, sprite = 61, x = 1839.6, y= 3672.93, z= 34.28},
    {id = "hosp2", name = "HAIGLA", scale = 0.75, color = 2, sprite = 61, x = -247.76, y= 6331.23, z=32.43},
    {id = "hosp3", name = "HAIGLA", scale = 0.75, color = 2, sprite = 61, x = -449.67, y= -340.83, z= 34.50},
    {id = "hosp4", name = "HAIGLA", scale = 0.75, color = 2, sprite = 61, x = 357.43, y= -593.36, z= 28.79},
    {id = "hosp5", name = "HAIGLA", scale = 0.75, color = 2, sprite = 61, x = 295.83, y= -1446.94, z= 29.97},
    {id = "hosp6", name = "HAIGLA", scale = 0.75, color = 2, sprite = 61, x = -676.98, y= 310.68, z= 83.08},
    {id = "hosp7", name = "HAIGLA", scale = 0.75, color = 2, sprite = 61, x = 1151.21, y= -1529.62, z= 35.37},
    {id = "hosp8", name = "HAIGLA", scale = 0.75, color = 2, sprite = 61, x = -874.64, y= -307.71, z= 39.58},
    {id = "cloth1", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = 425.236, y=-806.008, z=29.491},
    {id = "cloth2", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = -162.658, y=-303.397, z=39.733},
    {id = "cloth3", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = 75.950, y=-1392.891, z=29.376},
    {id = "cloth4", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = -822.194, y=-1074.134, z=11.328},
    {id = "cloth5", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = -1450.711, y=-236.83, z=49.809},
    {id = "cloth6", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = 4.254, y=6512.813, z=31.877},
    {id = "cloth7", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = 615.180, y=2762.933, z=44.088},
    {id = "cloth8", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = 1196.785, y=2709.558, z=38.222},
    {id = "cloth9", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = -3171.453, y=1043.857, z=20.863},
    {id = "cloth10", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = -1100.959, y=2710.211, z=19.107},
    {id = "cloth11", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = -1192.9453125, y=-772.62481689453, z=17.3254737854},
    {id = "cloth12", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = -707.33416748047, y=-155.07914733887, z=37.415187835693},

    {id = "cloth13", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = 1683.45667, y=4823.17725, z=42.1631294},
    {id = "cloth14", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = -712.215881, y=-155.352982, z=37.4151268},
    {id = "cloth15", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x =121.76, y=-224.6, z=54.56},
    {id = "cloth16", name = "RIIETE POOD", scale = 0.6, color = 3, sprite = 73, x = -1207.5267333984, y=-1456.9530029297, z=4.3763856887817},
...
--    {id = "Smelting", name = "Smelting", color = 17, sprite = 52, x = 1098.10168457031, y=-1999.86364746094, z=30.3807010650635},
    ...
    {id = "tuletõrje", name = "TULETÕRJE", sprite = 436, x = 217.97579, y=-1637.189, z=29.410442},

    {id = "maksed", name = "RIIGI HÕIVE", scale = 1.5, sprite = 351, color = 2, x= -1082.849, y= -247.949, z= 37.76324},
    {id = "jcenter", name = "CV KESKUS", scale = 1.5, sprite = 351, color = 2, x=172.78, y=-26.89, z=68.35},
 ...
 --   {id = "fishingsales", name = "Fish Sales", scale = 0.7, color = 7, sprite = 304, x=-1038.4649658203, y=-1396.7390136719, z=5.5531921386719},
    ...
    {id = "tuner", name = "TUUNERID", scale = 0.6, color = 44, sprite = 380, x = 936.83813, y= -968.6353, z= 38.84},

    {id = "tuner", name = "JÕUALA", scale = 0.6, color = 63, sprite = 311, x = -1209.78, y= -1574.552, z= 4.6079931},
    ...
    if resource == GetCurrentResourceName() then
        Citizen.CreateThread(function()
            for k,v in ipairs(blips) do
                QBCore.BlipManager.CreateBlip(v.id, v)
            end
        end)
    end
end)
